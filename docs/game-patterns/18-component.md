...
[Image: A class diagram. Zone has collision code and inherits from GameObject. Decoration also inherits from GameObject and has rendering code. Prop inherits from Zone but then has redundant rendering code.]
...
> performance and cache coherence. Components make it easier to use the [ Data Locality](data_locality.html) pattern to organize
...
> Locality](data_locality.html) chapter has more details.
...
> Four [Factory
> Method](http://c2.com/cgi/wiki?FactoryMethod) pattern.
...
> *queue* messages to be delivered later. For more on this, see [Event Queue](event_queue.html).
...
> The Gang of Four call this the [Mediator](http://c2.com/cgi-bin/wiki?MediatorPattern) pattern —
...
- Microsoft’s [XNA](http://creators.xna.com/en-US/) game framework
...
- This pattern bears resemblance to the Gang of Four’s [Strategy](http://c2.com/cgi-bin/wiki?StrategyPattern) pattern. Both
