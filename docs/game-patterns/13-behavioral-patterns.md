...
maintainable behavior. [Type Objects](type_object.html) create
categories of behavior without the rigidity of defining an actual class. A
[Subclass Sandbox](subclass_sandbox.html) gives you a safe set of primitives
...
- [Subclass Sandbox](subclass_sandbox.html)

- [Type Object](type_object.html)
