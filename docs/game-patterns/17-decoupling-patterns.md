...
Queues](event_queue.html) decouple two objects communicating with each other,
both statically and *in time*. [Service Locators](service_locator.html) let
...
- [Event Queue](event_queue.html)

- [Service Locator](service_locator.html)
