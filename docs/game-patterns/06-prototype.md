...
Prototype · Design Patterns Revisited
...
[design pattern](http://en.wikipedia.org/wiki/Prototype_pattern). We’ll cover that here, but I’ll also
...
[Image: Parallel class hierarchies. Ghost, Demon, and Sorceror all inherit from Monster. GhostSpawner, DemonSpawner, and SorcerorSpawner inherit from Spawner.]

> I had to dig up a dusty UML book to make this diagram. The [Image: A UML arrow.] means “inherits from”.
...
[Image: A Spawner contains a prototype field referencing a Monster. It calls clone() on the prototype to create new monsters.]
...
to manage, which is why we instead use patterns like [Component](component.html) and [Type Object](type_object.html) to model different kinds of entities without
...
> In some ways, the [Type Object](type_object.html)
...
[Image: A Class contains a list of Methods. An Instance contains a list of Fields and a reference to its Class.]
...
[Image: An Object contains a mixed list of Fields and Methods.]
...
[Image: An Object contains Fields and Methods and a reference to another object that it delegates to.]
...
[Image: A Weapon object contains an attack() method and other methods. A Sword object contains fields and delegates to Weapon.]
